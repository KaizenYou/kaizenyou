...
const GlobeSection = () => {
    ...
    return (
        <div className="flex sm:flex-row flex-col items-center justify-center min-h-screen dark:bg-black  relative w-full">
            <div
                className="div z-50 lg:w-6/12 sm:w-8/12 md:w-7/12 w-full sm:min-h-screen min-h-fit flex items-center justify-center overflow-x-hidden "
            >
                <div className="flex flex-col items-center justify-center w-[90%] mt-32  sm:mt-0 sm:text-left text-center">
                    ...
                    <h1 className=" text-5xl md:text-6xl font-bold  bg-gradient-to-br from-slate-200 to-slate-500 bg-clip-text text-transparent w-full tracking-tight">Get the <span className="text-blue-500 block">Competitive Edge</span></h1>
            ...
            <div className="lg:w-6/12 sm:w-4/12 md:w-5/12 w-full relative sm:min-h-screen min-h-[60vh] overflow-hidden ">
